...
from config import YOUTUBE_IMG_URL, BOT
...
async def get_thumb(videoid):
    ...
    try:
        ...
        font2_size = 70
        font2 = ImageFont.truetype("AnieMusic/assets/font2.ttf", font2_size)
        arial = ImageFont.truetype("AnieMusic/assets/font2.ttf", 30)
        name_font = ImageFont.truetype("AnieMusic/assets/font.ttf", 40)
        
        para = textwrap.wrap(clear(title), width=32)  # Corrected title clearing
        j = 0
        draw.text(
            (6, 6), f"{BOT}", fill="Yellow", font=name_font
        )
        draw.text(
            (600, 200),
            f"NOW PLAYING",
